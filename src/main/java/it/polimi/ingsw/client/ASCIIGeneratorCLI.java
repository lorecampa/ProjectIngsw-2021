...
public class ASCIIGeneratorCLI {
    ...
    public static void main(String[] args) throws Exception {
        ASCIIGeneratorCLI artGen = new ASCIIGeneratorCLI();

        System.out.println();
        artGen.printTextArt("Masters Of Renaissance", ASCIIGeneratorCLI.ART_SIZE_MEDIUM, ASCIIArtFont.ART_FONT_SANS_SERIF, "+",  false);
        System.out.println();
        artGen.printTextArt("    1 : PLAY", ASCIIGeneratorCLI.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_SANS_SERIF, "*",  false);
     ...
     * @throws Exception
     */
    private void printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol, boolean invert) throws Exception {
     ...
     * @throws Exception
     */
    private void printTextArt(String artText, int textHeight,  boolean invert) throws Exception {
        printTextArt(artText, textHeight, ASCIIArtFont.ART_FONT_DIALOG, DEFAULT_ART_SYMBOL, invert);
    }
