...
class MarketControllerTest {
    ...
    void marketActionWithNoLeaders() {
        ...
        assertEquals(controller.getPlayerState(), PlayerState.MARKET_RESOURCE_POSITIONING);
    ...
    void marketActionWithTwoLeaders() {
        ...
        if (numOfWhiteMarble > 0){
            assertEquals(controller.getPlayerState(), PlayerState.WHITE_MARBLE_CONVERSION);
        }
